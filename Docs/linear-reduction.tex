...
We will progress through more and more complicated examples, beginning from the programming of a simple calculator until we ultimately have created an extensible programming language, which we call L-Lang.
...
\medskip
\pdfximage width .5\hsize{Images/currying.png}
...
\medskip
\pdfximage width .5\hsize{Images/expr.png}
\centerline{\pdfrefximage\the\pdflastximage}
\medskip
...
\medskip
\pdfximage width .5\hsize{Images/fib.png}
\centerline{\pdfrefximage\the\pdflastximage}
\medskip
