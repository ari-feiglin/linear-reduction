...
\def\fboxsep{.5pt}
\def\mb@#1#2{{}\mathop{\fbox{\vrule width0pt depth1.5pt height8pt$#1#2$}}\nolimits{}}
\def\mb#1{\mathpalette\mb@{#1}}
\def\mbt#1{{}\mathop{\fbox{\vrule width0pt depth1.5pt height8pt\ttt{#1}}}\nolimits{}}

\def\mbox@#1#2{{\fbox{$#1#2$}}}
\def\mbox#1{\mathpalette\mbox@{#1}}
...
\def\COLON{\mathsf{Colon}}
\def\LBRACK{\mathsf{Lbrack}}
\def\RBRACK{\mathsf{Rbrack}}
...
\def\BR{\hbox{\textbf{$\boldsymbol{\beta}$R}}}
\def\MBR{\hbox{\textbf{M$\boldsymbol{\beta}$R}}}
\def\REG {\hbox{\textbf{REG}}}
\def\CFL {\hbox{\textbf{CFL}}}
\def\DCFL{\hbox{\textbf{DCFL}}}
