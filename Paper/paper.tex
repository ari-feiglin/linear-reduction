...
\begin{example}
    ...
    \ari{I added a few sentences explaining this.}
...
\ari{Done.
And yeah, $\Sigma^\infty$ is important since products have a variable number of parameters.}
...
\ari{No, by the definition of these sets, they have this property.}
...
\begin{enumerate}
    \item $\term=\termp\cup\terms\cup\terma$, 
...
\ari{There was a slight mistake in the definition of $\exp$.}
